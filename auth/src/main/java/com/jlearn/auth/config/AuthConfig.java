...
import com.jlearn.auth.annotation.AnonymousAccess;
import com.jlearn.auth.auth.JwtAccessDeniedHandler;
import com.jlearn.auth.auth.JwtAuthEntryPoint;
import com.jlearn.auth.auth.TokenConfigurer;
import com.jlearn.auth.auth.TokenProvider;
import com.jlearn.auth.config.properties.LoginProperties;
import com.jlearn.auth.enums.RequestMethodEnum;
...
public class AuthConfig extends WebSecurityConfigurerAdapter {
    ...
    GrantedAuthorityDefaults grantedAuthorityDefaults() {
        return new GrantedAuthorityDefaults(loginProperties.getRolePrefix());
    }
            ...
            if(null != anonymousAccess) {
                ...
                switch (Objects.requireNonNull(request)) {
                    ...
                    case DELETE:
                        ...
                        break;
                    default:
                        other.addAll(infoEntry.getKey().getPatternsCondition().getPatterns());
                        break;
                }
